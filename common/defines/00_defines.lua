...
NDiplomacy = {
	...
	BASE_STAGE_COUP_DAILY_PP = 1.0,					-- Daily pp cost for staging a coup
	...
	OPINION_PER_VOLUNTEER = 4,						-- Opinion bonus per one sent volunteer division
	MAX_OPINION_FROM_VOLUNTEERS = 50,				-- Opinion bonus per one sent volunteer division
	...
	IDEOLOGY_JOIN_FACTION_MIN_LEVEL = 0.0,			-- ideology limit required to join faction
...
NCountry = {
	...
	BASE_STABILITY_WAR_FACTOR = -0.1,				-- Default stability war factor
